...
function Login(props) {
  ...
  return (
    ...
    <div className="login" id='box' onTouchMove={(el)=>{ready()}}>
        ...
        <div className="input-container">
          <label>Почта</label>
          <input type="email" name="gmail" defaultValue={mail} onChange={(el)=>{(setMail(el.target.value))}}  id='input' autoSave='true' required   autoComplete={'email'}/>
    ...
    <label for="show-pass">Показать пароль</label>
        ...
        <div className="button-container">
          <button className='login-btn' onClick={()=>{(    console.log(mail, password))}}>войти</button>
        </div> 
   </form>
   ...
   <div class="google-btn">
    ...
    return(
      <>
      <div className="register" id='box' onTouchMove={(el)=>{ready()}}>
        ...
        >
          <div className="input-container">
            <label>Почта</label>
            <input type="email" name="gmail"  id='input' autoSave='true' defaultValue={mail} onChange={(el)=>{(setMail(el.target.value))}}  required  placeholder='ivano@gmail.com' />
