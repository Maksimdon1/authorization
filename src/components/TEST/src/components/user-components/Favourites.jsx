...
export default function Favourites() {
    ...
    function data() {
        ...
        const list = require("../../flowers.json");
        ...
        list['products'].forEach((element) => {
          //  console.log(element)
            if(urls.includes(element["unique-url"])){
  ...
  return (
   ...
   <div className="favorites">
        ...
        <div className="list">
          {favorite.map((el)=>(
                <>
                  <Link to={`/product/${el["unique-url"]}`}>
                <div className="cart">
                    <div className="img" ><img src={require(`../../static-img/flor2/${el.Id}.png`)} alt="" srcset="" /></div>
                    <div className="item-info">
                    <div className="title">{el.title}</div>
                    <div className="delite"     onClick={(els)=> {    els.preventDefault();   deliteLike( el["unique-url"])}}>
