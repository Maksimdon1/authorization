...
export default function Product() {
  ...
  let [length, SetLength] = useState(product["length"] || 21);
  ...
  function shareProduct() {
    share({
      ...
      img:  `../static-img/flor2/${product.Id}.png`
    }
  ...
  useEffect(() => {
    ...
    var element = document.querySelector(".price-big");
